...
var $totalPageCountDom = document.querySelector('.totalPageCount');
var $page = document.querySelector('.page');
var $prevBtn = documnet.querySelector('.prevBtn');
...
function printImage(page) {
    var str = '';
    var getStartIndex = getStartIndex(page);
...
$nextBtn.addEventListener("click",function(){
    if(page>totalPageCount-1) return;
    page++;
    printImage(page);
    printPage(page)
});
...
$totalPageCountDom.innerHTML = totalPageCount;


/*
//사진 출력
var str = printImage(0, 2);
var str = printImage(3, 5);
var str = printImage(6, 8);
*/
